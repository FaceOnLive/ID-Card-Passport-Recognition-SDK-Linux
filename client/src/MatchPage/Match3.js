...
export class Match3 extends React.Component {
    ...
    Getface = async() => {
        ...
        var url = SERVER_ADDR + '/ocr/barcode_base64';
            ...
            if (xhr.readyState === 4) {
                if(xhr.status === 200) {
                    ...
                    if (errorCode == 0) {
                        ...
                        g_match3.setState({textData: textObj, imageData: imageObj});
                ...
                <div class="row justify-content-center mt-3">
                  <div class="col-md-6">
                    <div class="box-shadow p-1 text-center">
                        <h4 className="font-weight-bold my-2"><i className="fas fa-image"></i> Barcode/QR Code Recognition
                        </h4>
